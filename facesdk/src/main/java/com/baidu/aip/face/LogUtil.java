...
public class LogUtil {
     ...
     * The logcat level.
     */
    static int LOGCAT_LEVEL = 4;  //16;  //qb_20180512
     ...
     * The initialized.
     */
    static boolean initialized = true;  //true;  //qb_20180512 false--在sd卡根目录下创建log文件
    static boolean LOGFLAG = true;    //qb_20180512 用于决定是否打印日志
